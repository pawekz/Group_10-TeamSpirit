...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/teamspiritlogo.png"))); // NOI18N
        ...
        jLabel4.setPreferredSize(new java.awt.Dimension(110, 48));
        ...
        jLabel8.setText("You already have an account? ");
    ...
    private void SignUpBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpBtnActionPerformed
        ...
        try {
            ...
            username    = emailAddress.getText();
            Password = pass.getText();
            System.out.println(Password);
            
            query = "INSERT INTO admin(full_name, username, password)"+
